...
def	walkTest():
	...
	singleServoMove(leg1Servos[0],512+(leg1Values[0]/.325),step_cycle_time,"RED")
	...
	singleServoMove(leg2Servos[0],512+((leg1Values[0]-90.0)/.325),step_cycle_time,"RED")
	singleServoMove(leg2Servos[1],leg1Values[1],step_cycle_time,"GREEN")
	singleServoMove(leg2Servos[2],leg1Values[2],step_cycle_time,"GREEN")
