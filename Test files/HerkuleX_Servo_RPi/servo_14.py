...
def	walkTest():
	...
	while True :
		...
		for current_step in range(0,4):
			...
			time.sleep(2)
			leg1Values = calcLegValues(110,80,80,80,80,0) #step_low,step_high,start_x,start_y,end_x,end_y
			#leg 2 - Start Low
			leg2Values = calcLegValues(110,80,80,80,80,0) #step_low,step_high,start_x,start_y,end_x,end_y
