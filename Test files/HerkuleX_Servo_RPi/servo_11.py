	...
	while True :
		...
		for current_step in range(0,4):
			...
			if current_step == 0:
				#Leg 1
				print "------------------>> debug here"
				singleServoMove(leg1Servos[0],512-(legValues[3]/.325),step_cycle_time,"RED")#512+(legValues[0]/.325)
				singleServoMove(leg1Servos[1],legValues[4],step_cycle_time,"GREEN")
				singleServoMove(leg1Servos[2],legValues[5],step_cycle_time,"GREEN")			
				
				#Leg 2
				singleServoMove(leg2Servos[0],512+(legValues[0]-90/.325),step_double_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg2Servos[1],legValues[1],step_double_cycle_time,"GREEN")
				singleServoMove(leg2Servos[2],legValues[2],step_double_cycle_time,"GREEN")

				#Leg 4
				singleServoMove(leg4Servos[0],512+(legValues[6]/.325),step_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg4Servos[1],legValues[7],step_cycle_time,"GREEN")
				singleServoMove(leg4Servos[2],legValues[8],step_cycle_time,"GREEN")			

			if current_step == 1:
				#Leg 1
				singleServoMove(leg1Servos[0],512-(legValues[6]/.325),step_cycle_time,"RED")#512+(legValues[0]/.325)
				singleServoMove(leg1Servos[1],legValues[7],step_cycle_time,"GREEN")
				singleServoMove(leg1Servos[2],legValues[8],step_cycle_time,"GREEN")	

				#Leg 3
				singleServoMove(leg3Servos[0],512-(legValues[3]/.325),step_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg3Servos[1],legValues[4],step_cycle_time,"GREEN")
				singleServoMove(leg3Servos[2],legValues[5],step_cycle_time,"GREEN")
		
				#Leg 4
				singleServoMove(leg4Servos[0],512+(legValues[0]/.325),step_double_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg4Servos[1],legValues[1],step_double_cycle_time,"GREEN")
				singleServoMove(leg4Servos[2],legValues[2],step_double_cycle_time,"GREEN")		
			
			if current_step == 2:
				#Leg 1
				singleServoMove(leg1Servos[0],512-(legValues[0]/.325),step_double_cycle_time,"RED")#512+(legValues[0]/.325)
				singleServoMove(leg1Servos[1],legValues[1],step_double_cycle_time,"GREEN")
				singleServoMove(leg1Servos[2],legValues[2],step_double_cycle_time,"GREEN")
		
				#Leg 2
				singleServoMove(leg2Servos[0],512+(legValues[3]-90/.325),step_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg2Servos[1],legValues[4],step_cycle_time,"GREEN")
				singleServoMove(leg2Servos[2],legValues[5],step_cycle_time,"GREEN")

				#Leg 3
				singleServoMove(leg3Servos[0],512-(legValues[6]/.325),step_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg3Servos[1],legValues[7],step_cycle_time,"GREEN")
				singleServoMove(leg3Servos[2],legValues[8],step_cycle_time,"GREEN")
			
			if current_step == 3:
				#Leg 2
				singleServoMove(leg2Servos[0],512+(legValues[6]-90/.325),step_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg2Servos[1],legValues[7],step_cycle_time,"GREEN")
				singleServoMove(leg2Servos[2],legValues[8],step_cycle_time,"GREEN")

				#Leg 3
				singleServoMove(leg3Servos[0],512-(legValues[0]/.325),step_double_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg3Servos[1],legValues[1],step_double_cycle_time,"GREEN")
				singleServoMove(leg3Servos[2],legValues[2],step_double_cycle_time,"GREEN")
		
				#Leg 4
				singleServoMove(leg4Servos[0],512+(legValues[3]/.325),step_cycle_time,"BLUE")#512+(legValues[0]/.325)
				singleServoMove(leg4Servos[1],legValues[4],step_cycle_time,"GREEN")
				singleServoMove(leg4Servos[2],legValues[5],step_cycle_time,"GREEN")		
