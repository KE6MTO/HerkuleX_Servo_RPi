...
def calcLegValues(step_low,step_high,start_x,start_y,end_x,end_y):
	...
	if debug == "true": #show debug information
		print "Updated X: " + str(updated_base_x_coord)
		print "Updated Y: " + str(updated_base_y_coord)
...
def	walkTest():
	...
	print "Leg 1"
	leg1Values = calcLegValues(110,80,80,80,80,80) #step_low,step_high,start_x,start_y,end_x,end_y
	print "Leg 2"
	leg2Values = calcLegValues(110,80,80,80,80,-80) #step_low,step_high,start_x,start_y,end_x,end_y
	print "Leg 3"
	leg3Values = calcLegValues(110,80,80,80,-80,-80) #step_low,step_high,start_x,start_y,end_x,end_y
	print "Leg 4"
	leg4Values = calcLegValues(110,80,80,80,-80,80) #step_low,step_high,start_x,start_y,end_x,end_y
	print "-----> Move legs now"
	singleServoMove(leg1Servos[0],512-((leg1Values[6]-45.0)/.325),step_cycle_time,"RED")
	singleServoMove(leg1Servos[1],leg1Values[7],step_cycle_time,"GREEN")
	singleServoMove(leg1Servos[2],leg1Values[8],step_cycle_time,"GREEN")
	
	if leg2Values[6] <= 0:
		singleServoMove(leg2Servos[0],512+(leg2Values[6]+45.0/.325),step_cycle_time,"RED")
	singleServoMove(leg2Servos[1],leg2Values[7],step_cycle_time,"GREEN")
	singleServoMove(leg2Servos[2],leg2Values[8],step_cycle_time,"GREEN")

	singleServoMove(leg3Servos[0],512+(leg3Values[6]+0.0/.325),step_cycle_time,"RED")
	singleServoMove(leg3Servos[1],leg3Values[7],step_cycle_time,"GREEN")
	singleServoMove(leg3Servos[2],leg3Values[8],step_cycle_time,"GREEN")
	
	singleServoMove(leg4Servos[0],512-(leg4Values[6]-45.0/.325),step_cycle_time,"RED")
	singleServoMove(leg4Servos[1],leg4Values[7],step_cycle_time,"GREEN")
	singleServoMove(leg4Servos[2],leg4Values[8],step_cycle_time,"GREEN")
